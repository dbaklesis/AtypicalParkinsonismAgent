...
:: 2. Εκτέλεση Pipeline (PubMed + ClinicalTrials + AI Screening + Summaries)
python "C:\AtypicalParkinsonismAgent\src\run_pipeline.py"  --screen-limit 50 --summary-limit 50 >> "C:\AtypicalParkinsonismAgent\logs\agent_execution.log" 2>&1
